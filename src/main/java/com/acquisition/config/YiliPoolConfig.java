...
public class YiliPoolConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        for (CjDataSourceConnDefine dta : allconninfo) {
            ...
            groupPoolFactory.setConfigurationParameter(DatabaseType.AdapterDatabaseType(dta.getDataBaseType()), "", dta.getConnIp(), dta.getConnPort(), dta.getDataSourceSchema(), dta.getLoginName(), dta.getLoginPassword());
        }
