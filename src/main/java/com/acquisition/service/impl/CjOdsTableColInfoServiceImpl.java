...
public class CjOdsTableColInfoServiceImpl implements CjOdsTableColInfoService {
    ...
    @Override
    public String findOdsDataTable(String businessSystemNameShortName, String dataSourceSchema, String dataSourceTable) {
        return cjOdsTableColInfoMapper.findOdsDataTable(businessSystemNameShortName,dataSourceSchema,dataSourceTable);
    }

    @Override
    public List<CjOdsTableColInfo> findFieldByodsDataTable(String odsDataTable) {
        return cjOdsTableColInfoMapper.selectFieldByodsDataTable(odsDataTable);
    }
